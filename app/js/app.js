angular.module('app', ['ngResource', 'ui.router', 'ngRoute', 'ngSanitize', 'ngAnimate', 'frapontillo.bootstrap-switch', 'mgcrea.ngStrap']).run(function($rootScope, $state, Redirect) {
